...
void loop()
{
   ...
   Serial.print("Angle Y: "); Serial.print(Angle[1]); Serial.print("n------------n");Serial.print(" - X: ");Serial.print(AcX);Serial.print(" - Y: ");Serial.print(AcY);Serial.print(" - Z: ");Serial.println(AcZ);
